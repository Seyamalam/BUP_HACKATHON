...
4.  LLM, Technology, Security & Repository Policy
...
5.  Testing & Submission Checklist
...
p95 latency p95 <= 5s: 3/3 latency points; >5s to 15s: 2/3; Repeated LLM/API slowness reduces >15s to 30s: 1/3; >30s: 0/3 and timed-out requests the Performance & Reliability score.
are failures.
